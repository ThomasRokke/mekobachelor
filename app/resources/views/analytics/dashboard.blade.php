...
@section('content')
    ...
    <div class="ui container" style="margin-top:10px">
        ...
        @if(Auth::check() && Auth::user()->hasRole('admin') && ($orders > 0))

            <div class="ui segment">
                <div class="ui five statistics">
                    <div class="statistic">
                        <div class="value">{{ $totalRoutes }} <span style="font-size: 0.4em"></span> </div>
                        <div class="label">Turer</div>
                    </div>

                    <div class="statistic">
                        <div class="value">{{ round($totalKM / $orders, 1) }} <span style="font-size: 0.4em">km</span></div>
                        <div class="label">per ordre</div>
                    </div>

                    <div class="statistic">
                        <div class="value">{{ round($totalKM / $stops, 1) }} <span style="font-size: 0.4em">km</span></div>
                        <div class="label">per dropp</div>
                    </div>
