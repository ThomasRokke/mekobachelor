    ...
    <main style="margin-bottom: 30vh;">
        ...
        <div class="ui text  container" style="margin-top:80px;" >
            ...
            <div class="main-content">
                ...
                <div class="ui horizontal divider">Registrer ny bruker <i class="icon user"></i></div>
                ...
                <form method="POST" action="{{ route('register') }}" class="ui form segment">
                    ...
                    <div class="two fields">
                        <div class="field">
                            <div class="ui left icon input">
                                <i class="user icon"></i>
                                <input type="text" name="name" value="{{ old('name') }}" placeholder="Navn navnesen">
                            </div>
                        </div>
                        <div class="field">
                            <div class="ui left icon input">
                                <i class="mail icon"></i>
                                <input type="text" value="{{ old('email') }}" name="email" placeholder="E-post adresse">
                            </div>
                        </div>
                    </div>
                    <div class="two fields">
                        ...
                        <div class="field">
                            <div class="ui left icon input">
                                <i class="lock icon"></i>
                                <input type="password" name="password_confirmation" placeholder="Gjenta Passord">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="two fields">
                        <div class="field">
                            <div class="ui basic positive submit button">Registrer bruker <i class="icon send"></i></div>
                        </div>
