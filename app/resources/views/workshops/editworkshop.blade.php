                ...
                <form method="POST" action="{{ route('postworkshopedit') }}" class="ui form segment">
                    ...
                    <div class="two fields">
                        <div class="field">
                            ...
                            <input placeholder="4001..." value="{{ $w->workshop_id }}" name="workshop_id" type="text">
                        </div>
                        <div class="field">
                            <label>Rute</label>

                            <input type="number" name="route" value="{{ $w->route }}" placeholder="10">
                        </div>
                    </div>
                    <div class="field">
                        <label>Verkstednavn</label>

                        <input type="text" name="name" value="{{ $w->name }}" placeholder="Stovnerbrua Servicesenter">
                    </div>
                    <div class="field">
                        <label>Lokasjon</label>
                        <div id="searchIcon"  class="ui icon input ">
                            <input type="text" id="from" placeholder="Søk i Google sin database..." disabled>
                        ...
                        <input type="hidden" name="fromID" id="fromID" value="{{ $w->place_id }}">
                        <input type="hidden" name="adr" id="adr" value="{{ $w->adr }}">
                        <input type="hidden" name="lat" id="lat" value="{{ $w->lat }}">
                        <input type="hidden" name="lng" id="lng" value="{{ $w->lng }}">
                        ...
                        <div id="fromAdr">
                            <div class="ui positive message">
                                Endre lokasjonen ved å trykke her
                            ...
                            <div class="ui dividing header">
                                ...
                                <div class="content">
                                    ...
                                    <div id="fromAdrFull" class="sub header">{{ $w->adr }}</div>


                                </div>
                                <i class="info icon"></i>
                                <div class="content">
                                    <div class="sub header">Lengdegrader: <span id="latspan">{{ $w->lat }}</span></div>
                                    <div class="sub header">Breddegrader: <span id="lngspan">{{ $w->lng }}</span></div>
