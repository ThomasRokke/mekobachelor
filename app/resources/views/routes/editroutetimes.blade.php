    ...
    <main style="margin-bottom: 30vh;">
        ...
        <div class="ui text  container" style="margin-top:80px;" >
            ...
            <div class="main-content">
                ...
                <div class="ui horizontal divider">Rediger rutetid <i class="icon clock"></i></div>
                <form method="POST" action="{{ route('postroutetimeedit') }}" class="ui form segment">
                    @csrf


                    <input type="hidden" name="routetimeid" value="{{ $routetime->id }}">
                    <div class="two fields">
                        <div class="field">
                            <label>Rute</label>

                            <input type="number" name="route" placeholder="10" value="{{ $routetime->route }}">
                        </div>
                        <div class="field">
                            <label>Klokken</label>
                            <input placeholder="4001..." name="time" type="time" value="{{ $routetime->time }}">
                        </div>
                    ...
                    <div class="two fields">
                        <div class="field">
                            ...
                            <input type="time" name="from_time" placeholder="10" value="{{ $routetime->from_time }}">
                        </div>
                        <div class="field">
                            <label>Til tid</label>
                            <input placeholder="4001..." name="to_time" type="time" value="{{ $routetime->to_time }}">
                        </div>
                ...
                <form method="POST" action="{{ route('deleteroutetimes') }}" class="ui form segment">
                    @csrf
                    ...
                    <div class="ui basic negative submit button">Slett rutetiden &nbsp;<i class="icon delete"></i></div>
                    <div class="ui error message"></div>
                </form>
